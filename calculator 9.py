...
def calculator():
    ...
    Цикл позволяет выполнять многократные вычисления до ввода 'выход'.
    ...
    print("Для завершения введите 'выход' в качестве операции.")
    ...
    while True:
        ...
        operation = input("Введите операцию (+, -, *, /, ^, sqrt, %, 'выход' для завершения): ")
