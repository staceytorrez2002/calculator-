...
def calculator():
    ...
    История вычислений сохраняется в памяти, доступна через команду 'history'.
    
    Returns:
        None: Выводит результаты вычислений в консоль.
    """
    history = []  # Список для хранения истории вычислений
    
    print("=" * 50)
    print("Простой калькулятор".center(50))
    print("Доступные операции: +, -, *, /, ^, sqrt, %".center(50))
    print("Команды: 'history' для истории, 'выход', 'q', 'exit' для завершения.".center(50))
    print("=" * 50)
    ...
    while True:
        ...
        operation = input("Введите операцию (+, -, *, /, ^, sqrt, %, 'history', 'выход', 'q', 'exit'): ")
