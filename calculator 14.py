...
def calculator():
    ...
    Команда 'clear' очищает историю вычислений.
    ...
    print("Команды: 'history' для истории, 'clear' для очистки истории, 'выход', 'q', 'exit' для завершения.".center(50))
    print("=" * 50)
    ...
    while True:
        ...
        operation = input("Введите операцию (+, -, *, /, ^, sqrt, %, 'history', 'clear', 'выход', 'q', 'exit'): ")
